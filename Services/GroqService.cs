...
namespace SnapMini.Services
{
    ...
    /// Reads GroqApiKey from appsettings.json or GROQ_API_KEY environment variable.
    /// </summary>
    public static class GroqService
    {
        ...
        private static string GetApiKey()
        {
            ...
            throw new InvalidOperationException(
                "Groq API Key missing! Please set 'GroqApiKey' inside appsettings.json or set GROQ_API_KEY environment variable.");
        }
        ...
        public static async Task<string> GetAnswerAsync(string inputText)
        {
            ...
            var payload = new
            {
                ...
                messages = new[]
                {
                    ...
                    {
                        role = "user",
                        content = "The following text was captured from the user's screen or selected text. It may be a " +
